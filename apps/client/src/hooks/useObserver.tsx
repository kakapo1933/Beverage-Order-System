 ...
 *
 * @param {IntersectionObserverCallback} observerCallback - callback function for the observer, don't forget to wrap it with useCallback.
...
export const useObserver = (observerCallback: IntersectionObserverCallback,
  observerConfig: IntersectionObserverInit = DEFAULT_OBSERVER_CONFIG): React.RefObject<HTMLElement> => {
