					...
					<div className='flex flex-col md:flex-row justify-between items-center mb-4 space-y-4 md:space-y-0'>
						<div className='flex justify-between w-full md:w-auto'>
							...
							<div className='relative md:hidden'>
								<Link
									...
									<span id='cart-icon-mobile' className='text-2xl transition-all duration-300' aria-hidden='true'>
										🛒
									</span>
									{cartCount > 0 && (
										<span
						...
						<div className='relative hidden md:block'>
							<Link
								...
								className='flex items-center hover:text-secondary-400 transition-colors'
								aria-label={`Shopping cart with ${cartCount} items`}>
								<span id='cart-icon' className='text-2xl transition-all duration-300' aria-hidden='true'>
									🛒
								</span>
								{cartCount > 0 && (
									<span
