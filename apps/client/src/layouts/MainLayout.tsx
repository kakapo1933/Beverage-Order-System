          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-4 space-y-4 md:space-y-0">
            <div className="flex justify-between w-full md:w-auto">
              ...
              <div className="relative md:hidden">
                ...
                >
                  <span id="cart-icon-mobile" className="text-2xl transition-all duration-300" aria-hidden="true">🛒</span>
                  {cartCount > 0 && (
                    <span 
            ...
            <div className="relative hidden md:block">
              <Link 
                ...
                aria-label={`Shopping cart with ${cartCount} items`}
              >
                <span id="cart-icon" className="text-2xl transition-all duration-300" aria-hidden="true">🛒</span>
                {cartCount > 0 && (
                  <span 
                    className="absolute -top-2 -right-2 bg-secondary-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center"
                    aria-hidden="true"
          ...
          {showCoupons && (
            <div className="mb-6 p-4 bg-white rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" role="list" aria-label="Available coupons">
                {/* Coupon Card 1 */}
                <div className="border border-dashed border-secondary-300 rounded-lg p-3 bg-secondary-50 relative" role="listitem">
