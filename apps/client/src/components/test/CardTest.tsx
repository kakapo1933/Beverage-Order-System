	...
	return (
		<div className='p-4 space-y-8'>
			...
			<div className='space-y-2'>
				...
				<Card className='w-64 p-4' title='Card Title' showHeader={true}>
			...
			<div className='space-y-2'>
				...
				<Card className='w-64 p-4' footer={<button className='text-blue-500'>Action</button>} showFooter={true}>
			...
			<div className='space-y-2'>
				...
				<Card ref={cardRef} className='w-64 p-4 cursor-pointer' onClick={logRefInfo}>
